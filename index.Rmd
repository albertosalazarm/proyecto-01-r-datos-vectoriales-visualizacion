...
ams_area <- world[ world$continent == "South America" & world$area_km2 >= 2500000  , ]
plot(ams_area["area_km2"], main="Países de Amer. del Sur con área superior a 2.5 millones de km2")

#Para la Variable población

ams_pop <- world[ world$continent == "South America" & world$pop >= 40000000  , ]
plot(ams_pop["pop"], main="Países de Amer. del Sur con población superior a 40 millones")
